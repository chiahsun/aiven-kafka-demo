...
run-sasl-plain:
	go run main.go scram_client.go -brokers kafka-126f65ba-chiahsun-7adf.aivencloud.com:16014 -username avnadmin -passwd jpm5joa17pb5sgwj -algorithm plain -topic partition-3 -certificate ./avnadmin.cert -key ./avnadmin.key -ca ./ca.pem -mode consume -logmsg -sasl
